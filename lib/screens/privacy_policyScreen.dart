...
By using Direct Chat, you agree that we may collect, use and share your information in accordance with this Privacy Policy, as revised from time to time. In addition, your use of Direct Chat signifies that you agree with the terms of this Privacy Policy. If you do not agree with the terms of this Privacy Policy, do not use Direct Chat.

This Privacy Policy is incorporated into and forms part of the Direct Chat Terms of Service that you have agreed to in order to use Direct Chat. Any terms used in this Privacy Policy will have the same meaning as the equivalent defined terms in the Direct Chat Terms of Service unless otherwise defined in this Privacy Policy or the context requires otherwise. Unless otherwise specified in this Privacy Policy, these terms in the Direct Chat Terms of Service shall also be applicable in this Privacy Policy.
...
any information included in your Direct Chat profile which are visible to other users of Direct Chat, or information you make available to us via your use of Direct Chat, which may include your photographs, your education, city or area and other information; information about your and others usage of and interaction with the service and our application, including usage by geographies, device and connection information, IP address, device capability, bandwidth, statistics on page views and network type; information we collect as you use Direct Chat, which may include: technical information, such as your mobile carrier-related information, configuration information made available by other programs you use to access Direct Chat, your IP address, your location/country/region/time zone, your device’s version and identification number, user settings, and the operating system; and information about the likes and dislikes you have made using Direct Chat.
...
Direct Chat takes the following permissions from you
...
For call history we used READ_CALL_LOG permission to show users their call history so they can directly send message from our app.

3.1 Purposes

We may use your Information for any of the following purposes:

to provide services to you (including both the services currently provided by us via Direct Chat and these services to be rendered by us via Direct Chat in future); to personalise and improve our services and your experiences when you use our services; to respond to inquiries, for the purposes of customer service, security, archival and backup purposes in connection with providing services of Direct Chat; to monitor and analyse usage and trends of our services; personalise the services by, among other things, suggesting friends or profile information, or customising the content we show you, including ads; enhance the safety and security of our products and services; verify your identity and prevent fraud or other unauthorised or illegal activity; use information we have collected from cookies and other technology to enhance the services and your experience with them; and enforce our Terms of Service and other usage polices.
...
""";
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: TextButton(
                        onPressed: () {
                          String url =
                              "https://mohitpareek25.github.io/Privacy-Policy/";
                          launchUrlString(url);
                        },
                        style: ButtonStyle(),
                        child: Text(
  ...
  List<TextSpan> _buildPrivacyPolicyText() {
    ...
    return privacyPolicy.split("\n").map((line) {
      ...
      final isSubheading = subheadings.contains(line.trim());
      return TextSpan(
        text: line + "\n",
        style: isHeading || isSubheading
            ? TextStyle(
                color: Color(0xff159957),
                fontSize: isHeading ? 25 : 18,
                fontFamily: "Helvetica-Neue2")
            : null,
      );
    }).toList();
